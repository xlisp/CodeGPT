...
| Step | Loss | tok/sec | ms/step | 说明 |
|------|------|---------|---------|------|
| 0 | 9.011 | 1,641 | 19,962 | 初始 ≈ ln(8192) = 9.01 ✓ |
| 1 | 8.908 | 1,686 | 19,424 | 快速下降 |
| 2 | 8.638 | 1,680 | 19,498 | |
| 3 | 8.220 | 1,674 | 19,565 | |
| 4 | 8.025 | 1,670 | 19,621 | |
| 5 | 7.768 | 1,632 | 20,073 | |
| 6 | 7.534 | 1,630 | 20,102 | |
| 7 | 7.361 | 1,631 | 20,086 | |

初始 loss = 9.011 ≈ ln(8192) = 9.012，符合预期（随机初始化下均匀预测所有 token 的理论 loss）。

**性能指标**：

| 指标 | 值 | 说明 |
|------|-----|------|
| tok/sec | ~1,640 | GTX 1080，无 FlashAttention，无 torch.compile |
| ms/step | ~19,500 | DEVICE_BS=4, T=2048, grad_accum=4 |
| MFU | 4.4% | 基于 GTX 1080 FP16 峰值 8.87 TFLOPS |
| 显存估算 | ~5-6 GB | 参数 fp32 (~200MB) + value_embeds + 激活值 |
