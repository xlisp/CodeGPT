# Mythos、Fable 5 的背后，其实是一条 70 年没人讲透的 AI 主线

> 为什么专家系统失败、贝叶斯网络沉寂，而 Transformer 最终走向 Mythos？从 AI 三大范式到自递归训练，一篇文章把这条历史主线完整串起来。
